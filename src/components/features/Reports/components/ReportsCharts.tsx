...
/**
 * Props do componente ReportsCharts
 */
 ...
 * @param {ReportsChartsProps} props - Props do componente
 * @returns {JSX.Element} Gráficos renderizados
 *
 * @example
 * <ReportsCharts
...
const ReportsCharts: React.FC<ReportsChartsProps> = ({
  ...
  /**
   * Renderiza o gráfico de pizza genérico
